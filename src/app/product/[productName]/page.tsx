                ...
                <div className=" items-center justify-center flex flex-col w-[50%] h-[650px]">
                    ...
                    <div className="flex mt-12 gap-10">
                        {["S", "M", "L", "XL", "XXL"].map((size) => (
                            <button
                                key={size}
                                className={`px-2 py-1 transition-all duration-300 hover:brightness-100 hover:scale-110 border-green-400 border-[2px] rounded-xl ${selectedSize === size
                    ...
                    <div className="flex mt-12 text-white font-bold text-l gap-10">
                        {[
                            ...
                            <button
                                key={color}
                                className={`p-2 uppercase flex gap-4 hover:scale-110 transition-all duration-300 border-green-400 border-[2px] rounded-xl ${selectedColor === color
                            ...
                            >
                                <div
                                    className={`w-6 h-6 rounded-full ${color === "black" ? "bg-black" : "bg-white"
                                        }`}
                                ></div>
